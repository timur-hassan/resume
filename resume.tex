...
\usepackage{titlesec}
\usepackage{titling}
\usepackage[includehead,margin=0.25in,headheight=80pt]{geometry}
\usepackage{graphicx}
\usepackage{wrapfig}
\usepackage{fancyhdr}
\usepackage{ifthen}
...
\fancyhead[L]{\ifthenelse{\value{page}=1}{\includegraphics[height=76pt]{portrait.jpg}}{}}
\fancyhead[C]{\ifthenelse{\value{page}=1}{\huge{\textbf{Timur Hassan}} \\ \large{Data Scientist}}{} }
\fancyhead[R]{\ifthenelse{\value{page}=1}{Australian Citizen \\ 0410 327 113 \\ timur.hassan@protonmail.com \\ linkedin.com/in/timur-hassan-20864818}}{}

\ifthenelse{\value{page}=2}{\fancyhf{}}{}
